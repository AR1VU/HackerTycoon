...
const WalletPanel: React.FC<WalletPanelProps> = ({ 
  ...
  return (
    ...
    >
      <div className="bg-black border-2 border-yellow-400 rounded-lg w-full max-w-5xl h-[80vh] mx-4 shadow-2xl shadow-yellow-500/20 flex flex-col">
        {/* Header */}
        ...
        <div className="p-4 border-t border-yellow-400/30 bg-black/50">
          <div className="text-center text-yellow-400 text-sm font-mono">
            ɄCoin - The Underground Currency • Secure • Anonymous • Untraceable
          </div>
        </div>
      </div>
    </div>
