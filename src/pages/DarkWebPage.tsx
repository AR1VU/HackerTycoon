...
const DarkWebPage: React.FC<DarkWebPageProps> = ({
  blackMarket,
  playerInventory,
  cryptoWallet,
  onPurchaseItem
  ...
  return (
    <div className="bg-black/90 backdrop-blur-sm border border-red-400/30 rounded-lg shadow-2xl shadow-red-500/20 flex flex-col h-full">
      {/* Header */}
